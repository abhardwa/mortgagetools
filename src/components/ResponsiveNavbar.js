    ...
    return (
        <div>
            <Navbar bg="dark" collapseOnSelect expand="sm">
                <Container>
                    <Navbar.Brand href="/"><img className="block mx-auto rounded-full lg:mx-0 lg:shrink-0" style={{height:'2.5rem', margin:'0px', padding:'0px'}} src={require("../img/BrandWhite.png")} alt="MortgageToolsUSA" /></Navbar.Brand>
