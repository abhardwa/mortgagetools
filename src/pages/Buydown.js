                        ...
                        <div className="site-container">
                            ...
                            <section>
                                <div className="container embed-slider main-text">
                                    <span className="text">If you refinance before using up your full&nbsp;
                                        <span id="escrow-amt" className="price-text inline">{currency.format(out.totalSavings)}</span> 
                                        &nbsp;credit, you can pay down your loan balance with what's left in the escrow account. 
                                        For example, if you refinance in &nbsp;
